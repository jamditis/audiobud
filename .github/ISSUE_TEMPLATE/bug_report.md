---
name: Bug Report
about: Create a report to help us improve AudioBud
title: "[BUG] "
labels: ["bug"]
assignees: ""
---
...
**Please search [existing issues](https://github.com/jamditis/audiobud/issues) to avoid duplicates.** Your bug may already be reported, so checking first helps keep things manageable.
